        ...
        <div class="row">
            <div class="col-lg-3 mb-3">
                <a class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="/"
                    ...
                    <span class="fs-5 h-font">Vinayak's Hotel</span>
                </a>
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5 class="text-dark text-decoration-underline">Guides</h5>
                <ul class="list-unstyled">
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5 class="text-dark text-decoration-underline">Projects</h5>
                <ul class="list-unstyled">
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5 class="text-dark text-decoration-underline">Community</h5>
                <ul class="list-unstyled">
